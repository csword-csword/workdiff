  ...
  return (
    <main style={{ maxWidth: '900px', margin: '0 auto', padding: '64px 64px' }}>
      ...
      <div className="bg-white border-3 border-[var(--black)] shadow-[8px_8px_0_var(--black)] p-12 relative">
        ...
        <h2 className="font-[var(--font-bebas)] text-4xl tracking-wider mb-8 text-[var(--black)] uppercase">
        ...
        <div className="space-y-6 text-lg text-[var(--charcoal)] leading-relaxed">
          ...
          <p className="pt-4">
            Since founding in 2013, WORK DIFFERENT has helped organizations establish scalable GTM strategies and execution that have allowed them to:
          </p>
